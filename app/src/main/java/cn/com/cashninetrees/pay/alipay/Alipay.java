package cn.com.cashninetrees.pay.alipay;
...
public class Alipay {
   ...
   private Handler mHandler;
    ...
    public void pay(final String info) {
        final String payInfo = buildOrderParam(info);
...
//    }
     ...
     * @return
     */
    public static String buildOrderParam(String payInfo) {
        StringBuilder sb = null;
        try {
            sb = new StringBuilder();
            JSONObject jo=new JSONObject(payInfo);
