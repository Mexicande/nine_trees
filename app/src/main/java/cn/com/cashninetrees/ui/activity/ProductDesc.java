...
import cn.com.cashninetrees.ui.adapter.SuperTextAdapter;
...
import cn.com.cashninetrees.utils.top_menu.MenuItem;
import cn.com.cashninetrees.utils.top_menu.TopRightMenu;
import cn.com.cashninetrees.view.RecyclerIntervalDecoration;
import cn.com.cashninetrees.view.RecyclerViewDecoration;
...
public class ProductDesc extends BaseActivity {
    ...
    private void dateInset(Product_DescBean.DataBean product) {
        ...
        if ("0".equals(interest_algorithm)) {
            ...
            tvCycle.setText(product.getMin_cycle() + "~" + product.getMax_cycle() + "天");
    ...
    private void initToolbar() {
        ...
        recommend.addItemDecoration(new RecyclerIntervalDecoration(15));
