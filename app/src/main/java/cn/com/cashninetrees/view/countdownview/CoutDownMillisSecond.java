package cn.com.cashninetrees.view.countdownview;
 ...
 *  毫秒右边快的倒计时
 */
public class CoutDownMillisSecond extends CountDownTimer {
    /**
    ...
    public void onTick(long millisUntilFinished) {
        ...
        if(view instanceof TextView){
            String.valueOf(millisUntilFinished%9);
            ((TextView) view).setText(String.valueOf(millisUntilFinished%9));
