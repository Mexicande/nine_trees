package cn.com.cashninetrees.view.seekbar;
...
import static cn.com.cashninetrees.view.seekbar.BubbleSeekBar.TextPosition.BELOW_SECTION_MARK;
import static cn.com.cashninetrees.view.seekbar.BubbleSeekBar.TextPosition.BOTTOM_SIDES;
import static cn.com.cashninetrees.view.seekbar.BubbleSeekBar.TextPosition.SIDES;
import static cn.com.cashninetrees.view.seekbar.BubbleUtils.dp2px;
import static cn.com.cashninetrees.view.seekbar.BubbleUtils.sp2px;
...
public class BubbleSeekBar extends View {
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTrackColor = a.getColor(R.styleable.BubbleSeekBar_bsb_track_color,
                ContextCompat.getColor(context, R.color.seekbardefault));
        ...
        mSectionTextSize = a.getDimensionPixelSize(R.styleable.BubbleSeekBar_bsb_section_text_size, sp2px(12));
        ...
        mBubbleTextSize = a.getDimensionPixelSize(R.styleable.BubbleSeekBar_bsb_bubble_text_size, sp2px(8));
