package cn.com.cashninetrees.view.supertextview;
...
//    private RelativeLayout.LayoutParams rightIVParams;
    ...
    private void getAttr(AttributeSet attrs) {
        TypedArray typedArray = mContext.obtainStyledAttributes(attrs, com.allen.library.R.styleable.CommonTextView);

        ////////设置文字或者图片资源////////
        mLeft_drawableLeft = typedArray.getDrawable(com.allen.library.R.styleable.CommonTextView_cLeftIconResForDrawableLeft);
        mLeft_drawableTop = typedArray.getDrawable(com.allen.library.R.styleable.CommonTextView_cLeftIconResForDrawableTop);
        mLeft_drawableRight = typedArray.getDrawable(com.allen.library.R.styleable.CommonTextView_cLeftIconResForDrawableRight);
        mLeft_drawableBottom = typedArray.getDrawable(com.allen.library.R.styleable.CommonTextView_cLeftIconResForDrawableBottom);

        mCenter_drawableLeft = typedArray.getDrawable(com.allen.library.R.styleable.CommonTextView_cCenterIconResForDrawableLeft);
        mCenter_drawableTop = typedArray.getDrawable(com.allen.library.R.styleable.CommonTextView_cCenterIconResForDrawableTop);
        mCenter_drawableRight = typedArray.getDrawable(com.allen.library.R.styleable.CommonTextView_cCenterIconResForDrawableRight);
        mCenter_drawableBottom = typedArray.getDrawable(com.allen.library.R.styleable.CommonTextView_cCenterIconResForDrawableBottom);

        mRight_drawableLeft = typedArray.getDrawable(com.allen.library.R.styleable.CommonTextView_cRightIconResForDrawableLeft);
        mRight_drawableTop = typedArray.getDrawable(com.allen.library.R.styleable.CommonTextView_cRightIconResForDrawableTop);
        mRight_drawableRight = typedArray.getDrawable(com.allen.library.R.styleable.CommonTextView_cRightIconResForDrawableRight);
        mRight_drawableBottom = typedArray.getDrawable(com.allen.library.R.styleable.CommonTextView_cRightIconResForDrawableBottom);

        mLeft_IV_drawable = typedArray.getDrawable(com.allen.library.R.styleable.CommonTextView_cLeftImageViewDrawableRes);
//        mRight_IV_drawable = typedArray.getDrawable(R.styleable.CommonTextView_cRightImageViewDrawableRes);
        /////////////////////

        mLeftTextString = typedArray.getString(com.allen.library.R.styleable.CommonTextView_cLeftTextString);
        mLeftTopTextString = typedArray.getString(com.allen.library.R.styleable.CommonTextView_cLeftTopTextString);
        mLeftBottomTextString = typedArray.getString(com.allen.library.R.styleable.CommonTextView_cLeftBottomTextString);

        mCenterTextString = typedArray.getString(com.allen.library.R.styleable.CommonTextView_cCenterTextString);
        mCenterTopTextString = typedArray.getString(com.allen.library.R.styleable.CommonTextView_cCenterTopTextString);
        mCenterBottomTextString = typedArray.getString(com.allen.library.R.styleable.CommonTextView_cCenterBottomTextString);

        mRightTextString = typedArray.getString(com.allen.library.R.styleable.CommonTextView_cRightTextString);
        mRightTopTextString = typedArray.getString(com.allen.library.R.styleable.CommonTextView_cRightTopTextString);
        mRightBottomTextString = typedArray.getString(com.allen.library.R.styleable.CommonTextView_cRightBottomTextString);

        mLeftTextColor = typedArray.getColor(com.allen.library.R.styleable.CommonTextView_cLeftTextColor, defaultColor);
        mLeftTopTextColor = typedArray.getColor(com.allen.library.R.styleable.CommonTextView_cLeftTopTextColor, defaultColor);
        mLeftBottomTextColor = typedArray.getColor(com.allen.library.R.styleable.CommonTextView_cLeftBottomTextColor, defaultColor);

        mCenterTextColor = typedArray.getColor(com.allen.library.R.styleable.CommonTextView_cCenterTextColor, defaultColor);
        mCenterTopTextColor = typedArray.getColor(com.allen.library.R.styleable.CommonTextView_cCenterTopTextColor, defaultColor);
        mCenterBottomTextColor = typedArray.getColor(com.allen.library.R.styleable.CommonTextView_cCenterBottomTextColor, defaultColor);

        mRightTextColor = typedArray.getColor(com.allen.library.R.styleable.CommonTextView_cRightTextColor, defaultColor);
        mRightTopTextColor = typedArray.getColor(com.allen.library.R.styleable.CommonTextView_cRightTopTextColor, defaultColor);
        mRightBottomTextColor = typedArray.getColor(com.allen.library.R.styleable.CommonTextView_cRightBottomTextColor, defaultColor);

        mLeftTextSize = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cLeftTextSize, defaultSize);
        mLeftTopTextSize = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cLeftTopTextSize, defaultSize);
        mLeftBottomTextSize = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cLeftBottomTextSize, defaultSize);

        mCenterTextSize = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cCenterTextSize, defaultSize);
        mCenterTopTextSize = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cCenterTopTextSize, defaultSize);
        mCenterBottomTextSize = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cCenterBottomTextSize, defaultSize);

        mRightTextSize = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cRightTextSize, defaultSize);
        mRightTopTextSize = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cRightTopTextSize, defaultSize);
        mRightBottomTextSize = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cRightBottomTextSize, defaultSize);

        mLeftIconDrawablePadding = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cLeftIconDrawablePadding, defaultPadding);
        mCenterIconDrawablePadding = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cCenterIconDrawablePadding, defaultPadding);
        mRightIconDrawablePadding = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cRightIconDrawablePadding, defaultPadding);

        mLeftViewPaddingLeft = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cLeftViewPaddingLeft, defaultPadding);
        mLeftViewPaddingRight = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cLeftViewPaddingRight, defaultPadding);
        mCenterViewPaddingLeft = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cCenterViewPaddingLeft, defaultPadding);
        mCenterViewPaddingRight = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cCenterViewPaddingRight, defaultPadding);
        mRightViewPaddingLeft = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cRightViewPaddingLeft, defaultPadding);
        mRightViewPaddingRight = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cRightViewPaddingRight, defaultPadding);

        mBothDividerLineMarginLeft = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cBothDividerLineMarginLeft, 0);
        mBothDividerLineMarginRight = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cBothDividerLineMarginRight, 0);

        mTopDividerLineMarginLR = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cTopDividerLineMarginLR, 0);
        mTopDividerLineMarginLeft = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cTopDividerLineMarginLeft, 0);
        mTopDividerLineMarginRight = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cTopDividerLineMarginRight, 0);

        mBottomDividerLineMarginLR = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cBottomDividerLineMarginLR, 0);
        mBottomDividerLineMarginLeft = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cBottomDividerLineMarginLeft, 0);
        mBottomDividerLineMarginRight = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cBottomDividerLineMarginRight, 0);

        mLeftImageViewMarginLeft = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cLeftImageViewMarginLeft, defaultPadding);
//        mRightImageViewMarginRight = typedArray.getDimensionPixelSize(R.styleable.CommonTextView_cRightImageViewMarginRight, defaultPadding);
        ...
        mCenterSpaceHeight = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cCenterSpaceHeight, mCenterSpaceHeight);


        mLeftTextViewLineSpacingExtra = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cLeftTextViewLineSpacingExtra, 0);
        mCenterTextViewLineSpacingExtra = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cCenterTextViewLineSpacingExtra, 0);
        mRightTextViewLineSpacingExtra = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cRightTextViewLineSpacingExtra, 0);

        mDividerLineType = typedArray.getInt(com.allen.library.R.styleable.CommonTextView_cShowDividerLineType, DEFAULT);
        mDividerLineColor = typedArray.getColor(com.allen.library.R.styleable.CommonTextView_cDividerLineColor, defaultDividerLineColor);

        mDividerLineHeight = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cDividerLineHeight, dip2px(mContext, 0.5f));

        useRipple = typedArray.getBoolean(com.allen.library.R.styleable.CommonTextView_cUseRipple, false);

        mBackgroundColor = typedArray.getColor(com.allen.library.R.styleable.CommonTextView_cBackgroundColor, mBackgroundColor);

        mSetSingleLine = typedArray.getBoolean(com.allen.library.R.styleable.CommonTextView_cSetSingleLine, true);
        mSetMaxEms = typedArray.getInt(com.allen.library.R.styleable.CommonTextView_cSetMaxEms, mSetMaxEms);
        mSetLines = typedArray.getInt(com.allen.library.R.styleable.CommonTextView_cSetLines, 1);

        mLeftTextViewGravity = typedArray.getInt(com.allen.library.R.styleable.CommonTextView_cLeftTextViewGravity, DEFAULT_Gravity);
        mCenterTextViewGravity = typedArray.getInt(com.allen.library.R.styleable.CommonTextView_cCenterTextViewGravity, DEFAULT_Gravity);
        mRightTextViewGravity = typedArray.getInt(com.allen.library.R.styleable.CommonTextView_cRightTextViewGravity, DEFAULT_Gravity);

        mLeftViewIsClickable = typedArray.getBoolean(com.allen.library.R.styleable.CommonTextView_cLeftViewIsClickable, false);
        mCenterViewIsClickable = typedArray.getBoolean(com.allen.library.R.styleable.CommonTextView_cCenterViewIsClickable, false);
        mRightViewIsClickable = typedArray.getBoolean(com.allen.library.R.styleable.CommonTextView_cRightViewIsClickable, false);

        mBackground_drawable = typedArray.getDrawable(com.allen.library.R.styleable.CommonTextView_cBackgroundDrawableRes);

        mIsCenterAlignLeft = typedArray.getBoolean(com.allen.library.R.styleable.CommonTextView_cIsCenterAlignLeft, false);
        mCenterViewMarginLeft = typedArray.getDimensionPixelSize(com.allen.library.R.styleable.CommonTextView_cCenterViewMarginLeft, dip2px(mContext, 200));
...
//        }
    ...
    private void initCommonTextView() {
        ...
        if (useRipple) {
            this.setBackgroundResource(com.allen.library.R.drawable.selector_white);
        }
    ...
    private void initCenterBaseLine() {
        if (centerBaseLineView == null) {
            ...
            centerBaseLineView.setId(com.allen.library.R.id.cCenterBaseLineId);
    ...
    private void initLeftImageView() {
        ...
        leftImageView.setId(com.allen.library.R.id.cLeftImageViewId);
...
//    }
    ...
    private void initLeftText() {
        if (leftTextView == null) {
            ...
            leftTVParams.addRule(RIGHT_OF, com.allen.library.R.id.cLeftImageViewId);
            leftTVParams.setMargins(mLeftViewPaddingLeft, 0, mLeftViewPaddingRight, 0);
            leftTextView = initText(leftTextView, leftTVParams, com.allen.library.R.id.cLeftTextId, mLeftTextColor, mLeftTextSize);
    ...
    private void initLeftTopText() {
        if (leftTopTextView == null) {
            ...
            leftTopTVParams.addRule(ABOVE, com.allen.library.R.id.cCenterBaseLineId);
            leftTopTVParams.addRule(RIGHT_OF, com.allen.library.R.id.cLeftImageViewId);
            leftTopTVParams.setMargins(mLeftViewPaddingLeft, 0, mLeftViewPaddingRight, 0);
            leftTopTextView = initText(leftTopTextView, leftTopTVParams, com.allen.library.R.id.cLeftTopTextId, mLeftTopTextColor, mLeftTopTextSize);
    ...
    private void initLeftBottomText() {
        if (leftBottomTextView == null) {
            ...
            leftBottomTVParams.addRule(BELOW, com.allen.library.R.id.cCenterBaseLineId);
            leftBottomTVParams.addRule(RIGHT_OF, com.allen.library.R.id.cLeftImageViewId);
            leftBottomTVParams.setMargins(mLeftViewPaddingLeft, 0, mLeftViewPaddingRight, 0);
            leftBottomTextView = initText(leftBottomTextView, leftBottomTVParams, com.allen.library.R.id.cLeftBottomTextId, mLeftBottomTextColor, mLeftBottomTextSize);
    ...
    private void initCenterText() {
        if (centerTextView == null) {
            ...
            if (mIsCenterAlignLeft) {
                centerTextView = initText(centerTextView, centerTVParams, com.allen.library.R.id.cCenterTextId, mCenterTextColor, mCenterTextSize);
    ...
    private void initCenterBottomText() {
        if (centerBottomTextView == null) {
            ...
            centerBottomTVParams.addRule(BELOW, com.allen.library.R.id.cCenterBaseLineId);
            centerBottomTVParams.setMargins(mCenterViewPaddingLeft, 0, mCenterViewPaddingRight, 0);
            centerBottomTextView = initText(centerBottomTextView, centerBottomTVParams, com.allen.library.R.id.cCenterBottomTextId, mCenterBottomTextColor, mCenterBottomTextSize);
    ...
    private void initRightText() {
        if (rightTextView == null) {
            ...
            rightTVParams.addRule(RelativeLayout.LEFT_OF, com.allen.library.R.id.cRightImageViewId);
            rightTVParams.setMargins(mRightViewPaddingLeft, 0, mRightViewPaddingRight, 0);
            rightTextView = initText(rightTextView, rightTVParams, com.allen.library.R.id.cRightTextId, mRightTextColor, mRightTextSize);
...
//            rightTextView.setGravity(Gravity.CENTER_VERTICAL | Gravity.RIGHT);
    ...
    private void initRightTopText() {
        if (rightTopTextView == null) {
            ...
            rightTopTVParams.addRule(ABOVE, com.allen.library.R.id.cCenterBaseLineId);
            rightTopTVParams.addRule(RelativeLayout.LEFT_OF, com.allen.library.R.id.cRightImageViewId);
            rightTopTVParams.setMargins(mRightViewPaddingLeft, 0, mRightViewPaddingRight, 0);
            rightTopTextView = initText(rightTopTextView, rightTopTVParams, com.allen.library.R.id.cRightTopTextId, mRightTopTextColor, mRightTopTextSize);
    ...
    private void initRightBottomText() {
        if (rightBottomTextView == null) {
            ...
            rightBottomTVParams.addRule(BELOW, com.allen.library.R.id.cCenterBaseLineId);
            rightBottomTVParams.addRule(RelativeLayout.LEFT_OF, com.allen.library.R.id.cRightImageViewId);
            rightBottomTVParams.setMargins(mRightViewPaddingLeft, 0, mRightViewPaddingRight, 0);
            rightBottomTextView = initText(rightBottomTextView, rightBottomTVParams, com.allen.library.R.id.cRightBottomTextId, mRightBottomTextColor, mRightBottomTextSize);
