...
public final class ActivityUtils {
    ...
    public static boolean isActivityExists(@NonNull final String pkg,
        ...
        return !(AppApplication.getApp().getPackageManager().resolveActivity(intent, 0) == null ||
                intent.resolveActivity(AppApplication.getApp().getPackageManager()) == null ||
                AppApplication.getApp().getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(AppApplication.getApp().getPackageName());
    }
    ...
    public static Drawable getActivityIcon(final Class<?> clz) {
        return getActivityIcon(new ComponentName(AppApplication.getApp(), clz));
    }
    ...
    private static Context getActivityOrApp() {
        ...
        return topActivity == null ? AppApplication.getApp() : topActivity;
    }
