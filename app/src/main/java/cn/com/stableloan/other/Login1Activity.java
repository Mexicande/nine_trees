...
import cn.com.stableloan.net.MyVolleySingle;
import cn.com.stableloan.net.UrlManager;
import cn.com.stableloan.net.VolleyStringPost;
    ...
    public void onClick(View v) {
        ...
        switch (id){
            case R.id.login_bt:
                ...
                break;
            case R.id.reg_user:
                Intent intent = new Intent(Login1Activity.this,RegistActivity.class);
...
//                        }
                        ...
                        if (user==null){
                            ...
                            try{
                                ...
                                AppApplication.user = (User) qb1.orderDesc(UserDao.Properties.U_id).list().get(0);
                                Log.i("---",AppApplication.user.getU_name());
                            }catch (Exception e){
                                toast("登录失败~_~");
                                return;
                            }
...
//            }
            if (what==1){
                toast("登录成功");
                //MyApp.user = user;
                writeInFile(AppApplication.user);
                Intent intent = new Intent(Login1Activity.this,Main1Activity.class);
    ...
    private void toast(String str){
        Toast.makeText(Login1Activity.this, str, Toast.LENGTH_SHORT).show();
    }
