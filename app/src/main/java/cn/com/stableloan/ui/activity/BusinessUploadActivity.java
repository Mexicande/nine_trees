...
public class BusinessUploadActivity extends BaseActivity {
                    ...
                    AppApplication.getUploadManager().put(path, null, token, new UpCompletionHandler() {
                        ...
                        public void complete(String key, ResponseInfo info, JSONObject response) {
                            if (info.isOK()) {
                                ...
                                Glide.with(BusinessUploadActivity.this).load(path).apply(options).into(fiv);
                                LogUtils.i("onActivityResult", selectList.size());

                                fiv.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        PictureSelector.create(BusinessUploadActivity.this).externalPicturePreview(selectList.size() - 1, selectList);
                                    }
                                });

                            } else {
                                ToastUtils.showToast(BusinessUploadActivity.this, "上传失败");
                            }
                        }
                    }, uploadOptions);
                    ...
                    public void onSuccess(String s, Call call, Response response) {
                        try {
                            ...
                            if ("1".equals(isSuccess)) {
                                ...
                                ToastUtils.showToast(BusinessUploadActivity.this, msg);
                            } else {
                                String msg = object.getString("msg");
                                ToastUtils.showToast(BusinessUploadActivity.this, msg);
