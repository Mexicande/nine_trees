...
public class CreditBankUploadActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_credit_bank_upload);
                    ...
                    public void onSuccess(String s, Call call, Response response) {
                        try {
                            ...
                            if ("1".equals(isSuccess)) {
                                ...
                                if ("1".equals(status)) {
                                    getToken();
                                    final String photo1 = jsonObject1.getString("credite_photo");
                                    if (photo1 != null) {
                                    ...
                                    if(!photo1.isEmpty()){
                                        ...
                                        Glide.with(CreditBankUploadActivity.this).load(photo1).apply(options).into(fiv);
                                        fiv.setOnClickListener(new View.OnClickListener() {
                                            @Override
                                            public void onClick(View v) {
                                                Intent intent = PictureActivity.newIntent(CreditBankUploadActivity.this, photo1, "信用卡照片");
                                                ActivityOptionsCompat optionsCompat = ActivityOptionsCompat.makeSceneTransitionAnimation(
                                                        CreditBankUploadActivity.this, fiv, PictureActivity.TRANSIT_PIC);
                                                try {
                                                    ActivityCompat.startActivity(CreditBankUploadActivity.this, intent, optionsCompat.toBundle());
                                    ...
                                    Intent intent = new Intent(CreditBankUploadActivity.this, Verify_PasswordActivity.class).putExtra("from", "CreditUpload");
                                    startActivity(intent);
                                }
                            }
                    ...
                    AppApplication.getUploadManager().put(path, null, token, new UpCompletionHandler() {
                        ...
                        public void complete(String key, ResponseInfo info, JSONObject response) {
                            if (info.isOK()) {
                                ...
                                Glide.with(CreditBankUploadActivity.this).load(path).apply(options).into(fiv);
                                LogUtils.i("onActivityResult", selectList.size());

                                fiv.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        PictureSelector.create(CreditBankUploadActivity.this).externalPicturePreview(selectList.size() - 1, selectList);
                                    }
                                });

                            } else {
                                ToastUtils.showToast(CreditBankUploadActivity.this, "上传失败");
                            }
                        }
                    }, uploadOptions);
                    ...
                    public void onSuccess(String s, Call call, Response response) {
                        try {
                            ...
                            if ("1".equals(isSuccess)) {
                                ...
                                ToastUtils.showToast(CreditBankUploadActivity.this, msg);
                            } else {
                                String msg = object.getString("msg");
                                ToastUtils.showToast(CreditBankUploadActivity.this, msg);
