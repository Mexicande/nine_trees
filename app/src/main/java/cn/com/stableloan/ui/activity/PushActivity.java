    ...
    private void setListener() {
        ...
        StateListener<String> wxStateListener = new StateListener<String>() {
            ...
            public void onComplete(String s) {
                ToastUtils.showToast(PushActivity.this, s);
            }

            @Override
            public void onError(String err) {
                ToastUtils.showToast(PushActivity.this, err);
            }

            @Override
            public void onCancel() {
                ToastUtils.showToast(PushActivity.this, "取消");
            }
        };
        ...
        productAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                startActivity(new Intent(PushActivity.this, ProductDesc.class).putExtra("pid", productAdapter.getData().get(position).getId()));
            }
        });
    ...
    private void getProductDate() {
        ...
        ApiService.GET_SERVICE(Urls.product.PRODUCT_DETAIL, jsonObject, new OnRequestDataListener() {
            ...
            public void requestFailure(int code, String msg) {
                ToastUtils.showToast(PushActivity.this, msg);
            }
        });
        ...
        switch (view.getId()) {
            ...
            case R.id.apply:
                if (TextUtils.isEmpty(token)) {
                    ...
                    startActivity(new Intent(PushActivity.this, HtmlActivity.class).putExtra("product", descBean));
                }
                break;
            case R.id.bt_share:
        ...
        if (TextUtils.isEmpty(token)) {
            ...
            ApiService.GET_SERVICE(Urls.product.PRODUCT_COLLECTION, jsonObject, new OnRequestDataListener() {
                ...
                public void requestSuccess(int code, JSONObject data) {
                    if (("1").equals(status)) {
                        shareFlag = true;
                        ToastUtils.showToast(PushActivity.this, "收藏成功");
                    } else {
                        shareFlag = false;
                        ToastUtils.showToast(PushActivity.this, "取消成功");
                    }
                }
