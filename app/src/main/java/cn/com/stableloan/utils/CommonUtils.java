...
public class CommonUtils {
    ...
    public static int dp2px(float dpValue) {
        final float scale = AppApplication.sApp.getResources().getDisplayMetrics().density;
    ...
    public static boolean hasNavigationBar() {
        ...
        WindowManager wm = (WindowManager) AppApplication.sApp.getSystemService(Context.WINDOW_SERVICE);
    ...
    public static int getNavigationBarHeightInPx() {
        ...
        Resources rs = AppApplication.sApp.getResources();
    ...
    public static File createImageFile(String fileName) {
        File dir = new File(AppApplication.sApp.getCacheDir(), "images");
