...
package cn.com.stableloan.view.hdprogress;
...
public class KProgressHUD {
    ...
    public KProgressHUD(Context context) {
        ...
        mWindowColor = context.getResources().getColor(com.kaopiz.kprogresshud.R.color.kprogresshud_default_color);
        mAnimateSpeed = 1;
        mCornerRadius = 10;
        mIsAutoDismiss = true;
        mGraceTimeMs = 0;
   ...
   */
    ...
    private class ProgressDialog extends Dialog {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.kprogresshud);
        ...
        /*    mBackgroundLayout = (BackgroundLayout) findViewById(R.id.background1);
            ...
            mCustomViewContainer = (FrameLayout) findViewById(R.id.container1);
            ...
            mLabelText = (TextView) findViewById(R.id.label1);
            if (mLabel != null) {
            ...
            mDetailsText = (TextView) findViewById(R.id.details_label1);
